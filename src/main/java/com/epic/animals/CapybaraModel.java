...
public class CapybaraModel extends EntityModel<CapybaraRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        CubeListBuilder ear = CubeListBuilder.create()
                .texOffs(0, 24).addBox(-0.5F, -2.0F, -1.0F, 1.0F, 2.0F, 2.0F);

        root.addOrReplaceChild("body",
                CubeListBuilder.create().texOffs(24, 0).addBox(-4.0F, -7.0F, -4.0F, 8.0F, 14.0F, 8.0F),
                PartPose.offsetAndRotation(0.0F, 16.0F, 2.0F, 1.45F, 0.0F, 0.0F));
        ...
        root.addOrReplaceChild("right_hind_leg",  leg, PartPose.offset(-2.0F, 19.0F,  8.0F));
        root.addOrReplaceChild("left_hind_leg",   leg, PartPose.offset( 2.0F, 19.0F,  8.0F));
        root.addOrReplaceChild("right_front_leg", leg, PartPose.offset(-2.0F, 19.0F, -2.0F));
        root.addOrReplaceChild("left_front_leg",  leg, PartPose.offset( 2.0F, 19.0F, -2.0F));
